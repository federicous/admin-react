...
export default function BasicExampleDataGrid() {
	...
	const columnsBloqueados = [
		// { field: 'code', headerName: 'Código', width: 130, flex:0.8 },
		{ field: 'gasto', headerName: 'Gasto', width: 230, flex:0.8, minWidth:110 },
		...
		{ field: 'detalle', headerName: 'Detalle', width: 130, flex:0.8, minWidth:110 },
		];
	...
	function removeElement(id) {
		setOpen(true);
		let cancel = false;
		apiQuery.delete(`/api/gastos/${id}`).then((response) => {
			if (cancel) return;
