...
export default function BasicExampleDataGrid() {
	...
	const columnsBloqueados = [
		...
		{ field: 'cliente', headerName: 'Cliente', width: 230, flex:1, minWidth:130 },
		...
		{ field: 'listaProductos', headerName: 'Lista Productos', width: 130, flex:1, minWidth:110 },
		{ field: 'vendedor', headerName: 'Vendedor', width: 130, flex:0.8, minWidth:110 },
		{ field: 'estado', headerName: 'Estado', width: 150, flex:0.8, minWidth:110 },
		];
	...
	function removeElement(id) {
		setOpen(true);
		let cancel = false;
		apiQuery.delete(`/api/pendientes/${id}`).then((response) => {
			if (cancel) return;
