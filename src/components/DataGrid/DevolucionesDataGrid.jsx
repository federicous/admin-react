...
export default function BasicExampleDataGrid() {
	...
	const columnsBloqueados = [
		...
		{ field: 'codigoProducto', headerName: 'Código Producto', width: 130, flex:0.8, minWidth:110 },
		{ field: 'vendedor', headerName: 'Vendedor', width: 130, flex:0.8, minWidth:110 },
		{ field: 'detalle', headerName: 'Detalle', width: 150, flex:2, minWidth:110 },
		];
	...
	function removeElement(id) {
		setOpen(true);
		let cancel = false;
		apiQuery.delete(`/api/devoluciones/${id}`).then((response) => {
			if (cancel) return;
