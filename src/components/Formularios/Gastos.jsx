...
const listaGastos =  ["alquiler", "combustible", "luz", "internet", "comisiones", "otros"]
      ...
      >
        ...
        >
          <Grid container spacing={2}>
            ...
            <Grid item md={6} xs={12}>
              <Seleccion campo={"gasto"} traductor={traductor} handleKey={handleKey} camposObject={camposObject} listaOpciones={listaGastos} readOnly={true} variant={"outlined"} required={true}/>
            </Grid>  
            {/* <Grid item md={6}  xs={12}>
            ...
            <Grid item md={12} xs={12}>
              <Texto campo={"detalle"} traductor={traductor} handleKey={handleKey} camposObject={camposObject} listaOpciones={vendedorLista} variant={"outlined"} required={true} multiline={true}/>
            </Grid>            
            {/* <Grid item md={12} xs={12}>
