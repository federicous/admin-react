...
export default function AddProduct() {
  ...
  const handleSubmit = (event) => {
    ...
    apiQuery
      ...
      .postFormData(`/api/devoluciones/`, data)
      .then((respuesta) => {
      ...
      >
        ...
        >
          <Grid container spacing={2}>
            ...
            <Grid item md={6}  xs={12}>
              <Texto campo={"codigoProducto"} traductor={traductor} handleKey={handleKey} camposObject={camposObject} required={true}  readOnly={false} type={"text"} variant={"outlined"}/>
            </Grid>   
            <Grid item md={6}  xs={12}>
              <Texto campo={"detalle"} traductor={traductor} handleKey={handleKey} camposObject={camposObject} required={true}  readOnly={false} type={"text"} variant={"outlined"} multiline={true}/>
            </Grid> 
            {/* <Grid item md={6}  xs={12}>
